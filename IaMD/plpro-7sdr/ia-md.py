...
top = GromacsTopFile(topfile, includeDir='/public/home/xdpeng/Apps/gromacs-2020.7/share/gromacs/top',
...
pocket_res = [111, 156, 161, 162, 163, 164, 165, 166, 170, 207, 245, 246, 247, 261, 263, 265, 266, 267, 268, 269, 270, 271, 272, 300, 301]
...
restraint = CustomCentroidBondForce(1, 'k*step(dr)*dr;dr=pointdistance(x1,y1,z1,h0,i0,j0)^2-0.1')
restraint.addGlobalParameter('k', 50.0*kilojoules_per_mole/nanometer)
restraint.addGroup(g3_atoms);
restraint.addGlobalParameter('h0', centroid3[0])
restraint.addGlobalParameter('i0', centroid3[1])
restraint.addGlobalParameter('j0', centroid3[2])
restraint.addBond([0])
system.addForce(restraint)
