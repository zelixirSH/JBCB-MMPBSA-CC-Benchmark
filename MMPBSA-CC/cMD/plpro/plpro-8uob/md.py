...
# Input Files
pdbfile = "plpro-8uob.pdb"
grofile = "plpro-8uob.gro"
outfile = "plpro-8uob"
gpuid = '0'
topfile = "topol.top"
...
g1_res = [i for i in range(89)]
g2_res = [i for i in range(124, 152)] + [i for i in range(168, 173)]
g3_res = [i for i in range(178, 235)] + [i for i in range(305, 310)]
