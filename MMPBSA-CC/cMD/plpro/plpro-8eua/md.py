...
# Input Files
pdbfile = "plpro-8eua.pdb"
grofile = "plpro-8eua.gro"
outfile = "plpro-8eua"
gpuid = '0'
topfile = "topol.top"
...
g1_res = [i for i in range(90)]
g2_res = [i for i in range(125, 153)] + [i for i in range(169, 174)]
g3_res = [i for i in range(179, 236)] + [i for i in range(306, 311)]
