...
# Input Files
pdbfile = "tnks2-9-em.pdb"
grofile = "tnks2-9-em.gro"
outfile = "tnks2-9-restraint"
gpuid = '0'
topfile = "topol.top"
...
round_res = [79, 80, 81, 82, 83, 84, 88, 96, 97, 98, 99, 100, 101, 102, 103, 107, 108, 109, 110, 111, 112, 113, 116, 117, 118, 120, 121, 123, 124, 145, 184, 185, 186, 187]
res_res = [i for i in range(1, 208+1) if i not in round_res]
